...
const questions = {
  ...
  second: `*(2/16) Ви…* \n\n 
    А) часто буваєте пригніченими чи відчуваєте безнадійність?\n\n
    В) схильні до занепокоєння або часто стривожені або нервуєте?\n\n
    С) буваєте роздратовані, не в дусі, бурчите зранку?\n\n
    D) буваєте не в дусі, роздратовані у певний період місяця?`,
  third: `*(3/16) Ви…* \n\n 
    А) відчуваєте себе краще споживаючи фрукти та ягоди?\n\n
  ...
  fifth: `*(5/16) У вас…*\n\n 
    А) зайва вага розподілена більш-менш рівномірно?\n\n
    В) обвислий живіт? \n\n
  ...
  sixth: `*(6/16) У вас…*\n\n 
    ...
    В) опухлі кісточки - залишаються сліди від шкарпеток? \n\n
  ...
  eleventh: `*(11/16) У вас…*\n\n 
    ...
    С) ви - сова та відчуваєте себе бадьоріше ввечері ?\n\n
